...
//CAT CONTROLS
	$(document).keydown(function(event){
    	...
    	case 39:
			$(".resting").fadeOut(100)
			$(".walkingRight").fadeIn(100)
			$(".cat").animate({left: "+=20"}, 0)
    	break;

    	case 40:
			$(".resting").fadeOut(100)
			$(".stretching").fadeIn(100)
    	break;
	...
	$(document).keyup(function(event){
		...
		$(".walkingLeft").fadeOut(100);
		$(".walkingRight").fadeOut(100);
		$(".standing").fadeOut(100);
		$(".stretching").fadeOut(100);
		$(".resting").fadeIn(100);
...
var name = $("#destination").data("name")
	...
	$(".go").on("click", function(event){
		...
		if(happiness <= -1) {
			window.location = "page4.html?name="+name+"&cat=black";
		} else if (0 <= happiness <= 3) {
			window.location = "page5.html?name="+name+"&cat=black";
	}
